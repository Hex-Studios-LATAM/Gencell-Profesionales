      ...
      <article className="max-w-4xl mx-auto bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden relative">
        ...
        <div className={`p-8 sm:p-14 lg:p-20 relative z-20 ${article.imageUrl ? 'bg-white rounded-t-[2rem] -mt-16 sm:-mt-24' : ''}`}>
           <div className="flex flex-wrap items-center gap-4 mb-8">
              <Link href="/profesional/publicaciones" className="text-slate-500 hover:text-sky-600 text-sm font-semibold transition flex items-center gap-2 bg-slate-100 hover:bg-sky-50 px-3 py-1.5 rounded-lg">
           ...
           {article.excerpt && (
             <div className="text-xl sm:text-2xl text-slate-500 font-medium italic mb-12 leading-relaxed border-l-4 border-sky-200 pl-6 py-2">
               {article.excerpt}
             </div>
           )}

           <div 
              className="prose prose-lg sm:prose-xl prose-slate prose-sky max-w-none text-slate-700 leading-relaxed render-article"
